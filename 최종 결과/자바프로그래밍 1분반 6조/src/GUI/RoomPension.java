...
public class RoomPension {
	 ...
	 */
	public RoomPension(Operator _o) {
		o=_o;
		initialize();
	}
	...
	private void initialize() {
	    ...
	    try { // 데이터베이스를 연결하는 과정
	    	...
	    	String query1 = "SELECT * FROM " + o.smf.area + "펜션"; // 모텔 sql문
		...
		ImageIcon chicon59 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -0.jpg");
		Image chimg59 = chicon59.getImage();
		Image cchimg59 = chimg59.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon59 = new ImageIcon(cchimg59);
		JLabel lblNewLabel_1_1_2 = new JLabel(cchicon59);
		...
		ImageIcon chicon60 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -1.jpg");
		Image chimg60 = chicon60.getImage();
		Image cchimg60 = chimg60.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon60 = new ImageIcon(cchimg60);
		JLabel lblNewLabel_1_1_2_1 = new JLabel(cchicon60);
		...
		ImageIcon chicon61 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -2.jpg");
		Image chimg61 = chicon61.getImage();
		Image cchimg61 = chimg61.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon61 = new ImageIcon(cchimg61);
		JLabel lblNewLabel_1_1_2_2 = new JLabel(cchicon61);
		...
		ImageIcon chicon62 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -3.jpg");
		Image chimg62 = chicon62.getImage();
		Image cchimg62 = chimg62.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon62 = new ImageIcon(cchimg62);
		JLabel lblNewLabel_1_1_2_3 = new JLabel(cchicon62);
		...
		ImageIcon chicon63 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -4.jpg");
		Image chimg63 = chicon63.getImage();
		Image cchimg63 = chimg63.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon63 = new ImageIcon(cchimg63);
		JLabel lblNewLabel_1_1_2_4 = new JLabel(cchicon63);
		...
		ImageIcon chicon64 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -5.jpg");
		Image chimg64 = chicon64.getImage();
		Image cchimg64 = chimg64.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon64 = new ImageIcon(cchimg64);
		JLabel lblNewLabel_1_1_2_5 = new JLabel(cchicon64);
		...
		ImageIcon chicon65 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -6.jpg");
		Image chimg65 = chicon65.getImage();
		Image cchimg65 = chimg65.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon65 = new ImageIcon(cchimg65);
		JLabel lblNewLabel_1_1_2_6 = new JLabel(cchicon65);
		...
		ImageIcon chicon66 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -7.jpg");
		Image chimg66 = chicon66.getImage();
		Image cchimg66 = chimg66.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon66 = new ImageIcon(cchimg66);
		JLabel lblNewLabel_1_1_2_7 = new JLabel(cchicon66);
		...
		ImageIcon chicon67 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -8.jpg");
		Image chimg67 = chicon67.getImage();
		Image cchimg67 = chimg67.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon67 = new ImageIcon(cchimg67);
		JLabel lblNewLabel_1_1_2_8 = new JLabel(cchicon67);
		...
		ImageIcon chicon68 = new ImageIcon("src/pension/"+o.smf.area+"펜션"+o.db.idx+"번째 -9.jpg");
		Image chimg68 = chicon68.getImage();
		Image cchimg68 = chimg68.getScaledInstance(120, 124, Image.SCALE_SMOOTH);
		ImageIcon cchicon68 = new ImageIcon(cchimg68);
		JLabel lblNewLabel_1_1_2_9 = new JLabel(cchicon68);
